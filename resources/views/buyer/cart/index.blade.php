    ...
    <section class="sec-product-detail bg12 p-t-65 p-b-60">
                        ...
                        @foreach ($carts as $cart)
                            <tr style="background-color: #e9d8d8">
                                ...
                                <td style="display: flex;color:#d52a2a">
                                    <i class="fa-solid fa-shop p-r-10"></i>{{ $cart->name_shop }}
                                </td>
                                <td></td>
                                <td></td>
                                <td></td>
                            ...
                            <tr>
                                ...
                                <td style="display: flex">
                                    ...
                                    <span style=" overflow-wrap: break-word;width:300px">{{ \Illuminate\Support\Str::limit($cart->name_product, 60, ' ...') }} </span>
                                    <span class="p-l-30">Phân loại: {{ $cart->size }}</span>
                                </td>
        ...
        <div class="buy-container">
            ...
            <div class="buy-button-container">
                ...
                <button type="button" class="flex-c-m stext-103 cl0 size-101 bg10 bor3 hov-btn1 p-lr-15 trans-04 fl-r" onclick="buySelected()">
                    Mua hàng
                </button>
            </div>
        </div>
