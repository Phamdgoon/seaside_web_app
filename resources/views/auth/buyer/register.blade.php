...
<body>
    <div class="header"> <a href="{{ route('client.home') }}" class="logo" style="color: #000">
            <p><b>SEASIDE</b> STORE / <span style="color: #a0a5a8">Đăng ký</span></p>
        </a>
    ...
    <div class="body">
        <div class="main">
            <div class="container b-container" id="b-container">
                <form class="form" id="b-form" method="POST" action="{{ route('buyer.register') }}">
            ...
            <div class="switch" id="switch-cnt">
                ...
                <div class="switch__container" id="switch-c1">
                    ...
                    <a class="switch__button button switch-btn" href="{{ route('buyer.login') }}">ĐĂNG NHẬP</a>
                </div>
