...
class User extends Authenticatable
{
    ...
    protected $fillable = ['username', 'email', 'phone_number', 'password', 'approved','remember_token', 'facebook_id', 'google_id', 'email_verification_token', 'email_verified', 'created_at', 'updated_at'];
